            ...
            >
              ...
              <defs>
                <radialGradient id="759c1415-0410-454c-8f7c-9a820de03641">
                  <stop stopColor="#EF4D48" />
                  <stop offset={1} stopColor="#f4514b" />
                </radialGradient>
              </defs>
            </svg>
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
              Find all the entertainment and biggest sports events you love with our IPTV service!
                
              </h2>
              <p className="mt-6 text-lg leading-8 text-gray-300">
               Say goodbye to freezing and buffering, as our advanced solutions ensure a lag-free viewing experience.
              </p>
